...
const PrintTemplateClearance = ({ resident, handleClose }) => {
      ...
      <>
        <div className="font-bold">
          ...
          <p className="mt-2">
            ...
            <strong>{new Date().toLocaleString("default", { month: "long" })}, {new Date().getFullYear()}</strong>, at Barangay {barangay?.barangay_name}, {barangay?.municipality}, {barangay?.province}.
          </p>
          <p className="mt-2">
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.signature}>
        ...
        <p>
          <strong>EDWARDSON CARCEDO</strong>
          <br />
...
export default PrintTemplateClearance;
